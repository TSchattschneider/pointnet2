...
def unpickle(filepath):
    '''Unpickles a file with compatibility for python 2 and 3.

    First tries to load a python 2 pickle file, and if that fails,
    tries to load a python 3 pickle file.

    Parameters
    ----------
    pickle_file : file
        The serialized pickle data to load
    ...
    try:
        ...
        print('Unable to unpickle data ', f, ': ', e)
        raise
    return data
...
class ScannetDataset():
    def __init__(self, root, npoints=8192, split='train'):
        ...
        self.scene_points_list = unpickle(self.data_filename)
        self.semantic_labels_list = unpickle(self.data_filename)
        if split == 'train':
